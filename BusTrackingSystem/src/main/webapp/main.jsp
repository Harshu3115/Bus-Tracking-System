...
<div class="action-row">
  ...
  <a href="viewAll" class="btn-lg-custom btn-view"><i class="fa fa-list"></i> View Buses</a>
        ...
        <table class="table table-bordered table-hover align-middle text-center">
            ...
            <%
                try {
                    ...
                    ResultSet rs = st.executeQuery("SELECT * FROM register_bus");
...
<!-- Footer -->
<footer class="text-center  p-4 footer" style="background: #2b7be9; color: white;  max-width: 100%; ">
